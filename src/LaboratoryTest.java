...
public class LaboratoryTest {
    ...
    public void addTestNew() { // Adding something new
        ...
        myLaboratory.addIngredient(new IngredientContainer(myIngredient));
    ...
    public void addTestSimpleName() { // Adding an already present ingredient (by simple name)
        ...
        myLaboratory.addIngredient(new IngredientContainer(myIngredient1));
        ...
        myLaboratory.addIngredient(new IngredientContainer(myIngredient2));
    ...
    public void getTestAllOverflow() { // Get all of an ingredient, confirming the overflow is wasted
        Ingredient myIngredient1 = new Ingredient("Sugar","(0,10)", State.POWDER,new Quantity(State.POWDER, Map.of(Unit.BARREL,1)));
        myLaboratory.addIngredient(new IngredientContainer(myIngredient1));

        Kettle myKettle = new Kettle();
        myLaboratory.setKettle(myKettle);

        Ingredient myIngredient2 = new Ingredient("Sugar","(0,10)", State.POWDER,new Quantity(State.POWDER, Map.of(Unit.SPOON,3)));
        myLaboratory.addIngredient(new IngredientContainer(myIngredient2));
